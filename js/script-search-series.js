...
const SEARCHAPI ="https://api.themoviedb.org/3/search/tv?&api_key=4d4efa39693d29d922bd207ecc5fdaec&query=";
...
if(params.type === 'movie'){
    window.location = `/resultado-filmes.html?s=${params.s}`;
}
            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="btn-group">
                            <a href="detalhes-serie.html?id=${id}" target="_self"><button type="button"
